...
def _process_document(file_path: str, original_name: str) -> int:
    print(f"[Documents] Isleniyor: {original_name}")
...
@router.post(
    ...
    description="""
Kurumsal doküman yükler ve bilgi tabanına ekler.
""",
)
async def upload_document(
    ...
    try:
        chunks_created = _process_document(save_path, file.filename)
    except Exception as e:
